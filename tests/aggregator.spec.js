...
function getTestData() {
  const ts = Date.now();
  const sectors = ['Technology', 'Healthcare', 'Finance', 'Education', 'Agricuture', 'Manufacturing', 'Retail', 'Real Estate', 'Transportation', 'Energy', 'Other'];
  return {
...
test.describe('Aggregator Registration - Positive', () => {
    ...
    test('TC_AGG_001 - Password visibility toggle works correctly', async ({ page }) => {
